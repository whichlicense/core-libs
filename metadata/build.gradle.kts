...
publishing {
    publications {
        create<MavenPublication>("metadata") {
            ...
            pom {
                name.set("WhichLicense core-libs/metadata")
                description.set("This library provides the Metadata marker interface.")
                url.set("https://github.com/whichlicense/core-libs/metadata")
                licenses {
                    license {
