...
publishing {
    publications {
        create<MavenPublication>("problem") {
            artifactId = "problem"
            ...
            pom {
                name.set("WhichLicense core-libs/problem")
                description.set("This library provides the Problem API to provide error messages based on RFC 7807.")
                url.set("https://github.com/whichlicense/core-libs/problem")
                licenses {
                    license {
...
signing {
    if (project.hasProperty("CI")) {
        ...
        sign(publishing.publications["problem"])
    }
}
