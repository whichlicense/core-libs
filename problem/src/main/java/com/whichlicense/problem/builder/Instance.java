...
public sealed interface Instance<S extends ProblemBuilderStep> extends ProblemBuilderStep permits FullProblemBuilder, PartialProblemBuilder {
    S instance(URI instance);
}
