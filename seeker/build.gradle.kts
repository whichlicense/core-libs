...
publishing {
    publications {
        create<MavenPublication>("seeker") {
            artifactId = "seeker"
            ...
            pom {
                name.set("WhichLicense core-libs/seeker")
                description.set("This library provides the MetadataSeeker SPI interface to facilitate metadata discovery.")
                url.set("https://github.com/whichlicense/core-libs/seeker")
                licenses {
                    license {
...
signing {
    if (project.hasProperty("CI")) {
        ...
        sign(publishing.publications["seeker"])
    }
}
